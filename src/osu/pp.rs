...
impl OsuPpInner {
    fn calculate(self) -> OsuPerformanceAttributes {
        ...
        let non_dt_bonus = match !self.mods.change_speed() && self.mods.rx() {
            true => 1.01,
            false => 1.0,
        };

        let pp = (aim_value.powf(1.1 * non_dt_bonus)
    ...
    fn compute_aim_value(&self) -> f64 {
        ...
        let len_bonus = 0.95
            ...
            + (total_hits > 2000.0) as u8 as f64 * (total_hits / 2000.0).log10() * 0.3;
        ...
        let ar_factor = if self.mods.rx() && self.attrs.ar > 10.66 {
            0.2 * (self.attrs.ar - 10.66)            
